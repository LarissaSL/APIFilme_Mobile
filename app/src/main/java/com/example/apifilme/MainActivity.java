...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Executa a solicitação da API
        fazerBuscaNaAPI("Divertidamente");
    }
            ...
            public void run() {
                try {
                    ...
                    runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            Toast.makeText(MainActivity.this, "Erro ao buscar dados da API: " + e, Toast.LENGTH_SHORT).show();
                        }
                    });
                }
            }
        ...
        runOnUiThread(new Runnable() {
            ...
            public void run() {
                if (resultado != null) {
                    ...
                    Toast.makeText(MainActivity.this, "Erro ao buscar dados da API", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
